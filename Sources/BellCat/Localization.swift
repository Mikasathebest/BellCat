...
enum L10n {
    ...
    private static let strings: [AppLanguage: [LKey: String]] = [
        ...
        .ja: [
            ...
            .backgroundOpacity: "背景の透明度：%d%%", .clickDragHint: "ステージをクリック、または点をドラッグ", .add: "追加", .delete: "削除", .quoteBy: "— %@"
        ],
        .es: [
            ...
            .backgroundOpacity: "Opacidad del fondo: %d%%", .clickDragHint: "Haz clic o arrastra el punto", .add: "Añadir", .delete: "Eliminar", .quoteBy: "— %@"
        ],
        .fr: [
            ...
            .backgroundOpacity: "Opacité du fond : %d%%", .clickDragHint: "Cliquez ou faites glisser le point", .add: "Ajouter", .delete: "Supprimer", .quoteBy: "— %@"
        ],
        .ar: [
            ...
            .backgroundOpacity: "شفافية الخلفية: %d%%", .clickDragHint: "انقر أو اسحب النقطة", .add: "إضافة", .delete: "حذف", .quoteBy: "— %@"
        ],
        .ko: [
            ...
            .backgroundOpacity: "배경 투명도: %d%%", .clickDragHint: "단계를 클릭하거나 점을 드래그", .add: "추가", .delete: "삭제", .quoteBy: "— %@"
        ]
    ]
}
